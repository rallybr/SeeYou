...
class CadastrarVideoPage extends StatefulWidget {
  const CadastrarVideoPage({Key? key}) : super(key: key);

  @override
  State<CadastrarVideoPage> createState() => _CadastrarVideoPageState();
}

class _CadastrarVideoPageState extends State<CadastrarVideoPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Cadastrar Vídeo', style: TextStyle(color: Color(0xFF7B2FF2), fontWeight: FontWeight.bold)),
        centerTitle: true,
        leading: IconButton(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: const [
                        Icon(Icons.video_collection_outlined, color: Color(0xFF7B2FF2), size: 32),
                        SizedBox(width: 12),
                        Text('Cadastrar Vídeo', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color(0xFF7B2FF2))),
                      ],
                    ),
